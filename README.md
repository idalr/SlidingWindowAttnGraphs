...
sum_get_tsne_rouge.py take GAT config file and args (num_print, random, rouge_score, bert_score, tsne, sent dist), get best model from the model_name + type graph