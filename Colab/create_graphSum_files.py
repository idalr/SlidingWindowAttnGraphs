...
#################################minirun
    ...
    ####################
    path_checkpoint = '/content/drive/MyDrive/ADG/HomoGraphs_GovReports/HomoGraphs_GovReports/Extended_NoTemp-epoch=11-Val_f1-ma=0.52.ckpt'
    ...
    sent_dict_disk = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/datasets/datasets/GovReport-Sum/vocab_sentences.csv')
