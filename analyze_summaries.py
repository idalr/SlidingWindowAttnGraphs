...
import warnings
import yaml
from src.pipeline.util_ana import visualize_tsne, compare_similariry, predict_sentences, plot_two_distributions, \
    extract_val_f1
...
from src.pipeline.connector import retrieve_parameters, get_sample_indices
...
def main_run(config_file, settings_file, num_print,
    ...
    if tsne:
        ...
        sampled_indices_test = get_sample_indices(len(dataset_test), num_print, random_sampling)
