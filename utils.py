...
def check_dataframe(df_):
    for i in range(len(df_)):
        ...
        if len(clean_tokenization_sent(articulos, 'text')) != len(clean_tokenization_sent(lista_lab, 'label')):
            ...
            print("#sentences and calculated labels do not match:",
                  len(clean_tokenization_sent(lista_lab, 'label')) - len(clean_tokenization_sent(articulos, 'text')))
